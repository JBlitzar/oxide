...
export const wasmrenderer_add_mesh_stl: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => number;
...
export const wasmrenderer_export_scene: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => void;
...
export const wasmrenderer_restore: (a: number, b: number, c: number) => void;
...
export const wasmrenderer_snapshot: (a: number, b: number) => void;
...
export const wasmrenderer_update_mesh: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
